...
<div>
    <div class="container">
        ...
        @if(Auth::user()->id==1)
                <h2>Add Plan</h2>
                <form class="form-horizontal" action="{{url('/healthplans')}}"   method="post" enctype="multipart/form-data"> 
                  {{ csrf_field() }}
                  <div class="form-group">
                    <label class="control-label col-sm-2" for="email">Plan Name:</label>
                    <div class="col-sm-10">
                ...
                <a href="{{url('/healthplans')}}" >View plans</a>
                @endif
                @endif
              </div>
</div>  
